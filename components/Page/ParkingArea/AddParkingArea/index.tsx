...
export default function AddParkingAreaDialog({ open, onOpenChange }: Props) {
  ...
  return (
    <Dialog open={open} onClose={handleOpenChange} maxWidth='xs'>
      <DialogTitle>New Parking Area</DialogTitle>

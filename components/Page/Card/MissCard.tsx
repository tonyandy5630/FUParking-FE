...
export default function MissCard({ id, refetch, setIsPending, disable }: { id: string, refetch: (options?: RefetchOptions) => Promise<QueryObserverResult<AxiosResponse<ListCardResponse, any>, Error>>, setIsPending: (isPending: boolean) => void, disable: boolean }) {
